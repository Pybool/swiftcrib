...
export function getCountryCurrencyByCountryCode(code: string) {
  const country = currencyCountryCodes.find(
    (country) => country.country_iso_2_char_code === code
  );
  return country ? country.currency_iso_3_char_code : null;
}
